package com.xy.framework.aspectj;
...
import com.xy.common.enums.BusinessStatus;
import com.xy.common.json.JSON;
...
public class LogAspect
{
    ...
    // 配置织入点
    @Pointcut("@annotation(com.xy.common.annotation.Log)")
